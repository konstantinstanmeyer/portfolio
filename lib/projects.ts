...
export const projects: Project[] = [
    ...
    },
    {
        ...
        githubUrl: 'https://github.com/konstantinstanmeyer/no-more-youth',
        image: '/projects/no-more-youth.gif',
    },
    {   
        id: 'png-recolor',
        title: 'png recolor',
        subtitle: 'PNG CSS Tool',
        type: 'Personal',
        year: '2025',
        description: 'Generates the CSS filter chain that recolors a flat PNG from one color to another. It solves for the filter values directly instead of searching for them, so the same input always gives the same output.',
        challenge: 'Finding a tool for png color filter recoloring is a chore, plain and simple.',
        solution: 'This one serves you results instantly, with 100% consistency, every click! Some of the highest accuracy around, and absolutely no tracking.',
    ...
    },
    {
        ...
        subtitle: 'Simplistic Guitar Tab Creation',
        type: 'Personal',
        year: '2026',
        description: "Built from a dissatisfaction of pre-existing sites for tablature, this site is fueled by a simplistic approach, and an ability to quickly create a musical reference. Utilizing keyboard-oriented navigation and exporting to a printable document, everything feels smooth—the way it should always be.",
        technologies: ['React', 'TypeScript', 'Vite'],
        timeline: '1 week',
        role: 'Development',
        liveUrl: 'https://guitar-tablature.vercel.app/',
        githubUrl: 'https://github.com/konstantinstanmeyer/guitar-tablature',
        image: '/projects/guitar-tablature.png',
    },
    {
        id: 'sm-2',
        title: 'SM-2',
